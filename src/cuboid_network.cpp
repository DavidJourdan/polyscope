...
void CuboidNetwork::prepare() {
  ...
  edgeProgram = render::engine->generateShaderProgram(
      {render::PASSTHRU_CUBOID_VERT_SHADER, render::CUBOID_GEOM_SHADER, render::CUBOID_FRAG_SHADER}, DrawMode::Points);
...
void CuboidNetwork::preparePick() {
  ...
  { // Set up edge picking program
    edgePickProgram = render::engine->generateShaderProgram(
        {render::CUBOID_PICK_VERT_SHADER, render::CUBOID_PICK_GEOM_SHADER, render::CUBOID_PICK_FRAG_SHADER},
        DrawMode::Points);
...
void CuboidNetwork::geometryChanged() {
  edgeProgram.reset();
